...
const moisture_routes_1 = require("./routes/moisture.routes");
...
async function startServer() {
    ...
    const dataProcessor = new data_processor_1.DataProcessor(cacheService, alertService, mqttService, websocketService);
    // Middleware
    ...
    app.use('/api/', limiter);
    // Routes
    app.use('/api/v1/moisture', (0, moisture_routes_1.createMoistureRoutes)(timescaleService, cacheService, alertService));
