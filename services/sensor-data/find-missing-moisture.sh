...
ssh -i ~/dev/th-lab01.pem ubuntu@43.209.22.250 "grep -A5 'Received moisture' /home/ubuntu/.pm2/logs/moisture-http-out.log | grep -E 'INFO.*Received|time\":|gw_id' | grep -B2 -A2 '\"(16|17|18|19|20|21):' | tail -20"

echo ""
echo "2. Messages sent to SQS from HTTP server:"
ssh -i ~/dev/th-lab01.pem ubuntu@43.209.22.250 "grep 'Sent to SQS successfully' /home/ubuntu/.pm2/logs/moisture-http-out.log | tail -10"
