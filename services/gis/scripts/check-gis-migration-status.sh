...
EC2_DB="postgresql://postgres:__ROTATED_DB_PASSWORD__@43.209.22.250:5432/munbon_dev"
...
PGPASSWORD='__ROTATED_DB_PASSWORD__' psql -h 43.209.22.250 -p 5432 -U postgres -d munbon_dev -c "\dn" 2>&1 | grep -E "gis|error"
