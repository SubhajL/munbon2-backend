...
exports.landPreparationService = exports.LandPreparationService = void 0;
const database_1 = require("@config/database");
const logger_1 = require("@utils/logger");
class LandPreparationService {
    RAI_TO_M3_FACTOR = 1.6;
    /**
     * Get land preparation water requirements for a crop type
     */
    async getLandPreparationRequirements(cropType) {
        try {
            const query = `
        SELECT 
          crop_type,
      ...
      `;
            ...
            if (result.rows.length === 0) {
                ...
                logger_1.logger.warn(`No land preparation data found for ${cropType}, using defaults`);
            ...
            logger_1.logger.error('Failed to get land preparation requirements', error);
            throw error;
        }
    }
    /**
     ...
     */
    async calculateLandPreparationDemand(cropType, areaRai, areaId, areaType, plantingDate) {
        try {
            ...
            logger_1.logger.error('Failed to calculate land preparation demand', error);
            throw error;
        }
    }
    /**
     ...
     */
    async saveLandPreparationCalculation(result) {
        try {
            const query = `
      ...
      `;
            ...
            logger_1.logger.error('Failed to save land preparation calculation', error);
            throw error;
        }
    }
    /**
...
exports.LandPreparationService = LandPreparationService;
exports.landPreparationService = new LandPreparationService();
//# sourceMappingURL=land-preparation.service.js.map