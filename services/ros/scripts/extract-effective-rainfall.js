...
async function extractEffectiveRainfall() {
    console.log(chalk_1.default.blue('📊 Extracting Effective Rainfall Data from Excel'));
    ...
    if (!sheet) {
        console.error(chalk_1.default.red('❌ Sheet "ฝนใช้การรายวัน" not found!'));
        return;
    }
...
//# sourceMappingURL=extract-effective-rainfall.js.map