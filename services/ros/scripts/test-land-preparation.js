 ...
 */
function calculateWithLandPreparation() {
    ...
    crops.forEach(crop => {
        ...
        console.log(`${crop.type.padEnd(10)} | ` +
...
function compareWithoutLandPreparation() {
    ...
    scenarios.forEach(s => {
        ...
        console.log(`${s.area.toLocaleString().padStart(10)} | ` +
...
//# sourceMappingURL=test-land-preparation.js.map