...
# To:
DATABASE_URL=postgresql://postgres:__ROTATED_DB_PASSWORD__@43.209.12.182:5432/munbon_dev?schema=auth
```
...
# To:
DATABASE_URL=postgresql://postgres:__ROTATED_DB_PASSWORD__@43.209.12.182:5432/munbon_dev?schema=gis
```
...
# To:
DATABASE_URL=postgresql://postgres:__ROTATED_DB_PASSWORD__@43.209.12.182:5432/sensor_data
```
...
# To:
TIMESCALE_URL=postgresql://postgres:__ROTATED_DB_PASSWORD__@43.209.12.182:5432/sensor_data
```
...
# To:
DATABASE_URL=postgresql://postgres:__ROTATED_DB_PASSWORD__@43.209.12.182:5432/munbon_dev
TIMESCALE_URL=postgresql://postgres:__ROTATED_DB_PASSWORD__@43.209.12.182:5432/sensor_data
```
