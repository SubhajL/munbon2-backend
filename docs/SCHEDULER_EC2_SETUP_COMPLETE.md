...
- **Connection String**: `postgresql://postgres:__ROTATED_DB_PASSWORD__@43.209.22.250:5432/munbon_dev`
...
```bash
psql "postgresql://postgres:__ROTATED_DB_PASSWORD__@43.209.22.250:5432/munbon_dev"
```
